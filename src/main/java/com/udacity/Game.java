...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
        ...
        /*for (int i = 0; i < 3; i++) {
            char consideredColumn[] = {'-', '-', '-'};
            for (int j = 0; j < 3; j++) {
                consideredColumn[j] = grid[i][j];
            }
            if (consideredColumn[0] != '-' && consideredColumn[1] != '-' && consideredColumn[2] != '-') {
                if (consideredColumn[0] == 'x' && consideredColumn[1] == 'x' && consideredColumn[2] == 'x') {
                    result = "X Wins";
                } else {
                    if (consideredColumn[0] == 'o' && consideredColumn[1] == 'o' && consideredColumn[2] == 'o') {
                        result = "O Wins";
                    }
                }
                return result;
        ...
        if ((grid[0][0] != '-' && grid[1][1] != '-' && grid[2][2] != '-') && (grid[0][0] == grid[1][1] && grid[2][2] == grid[1][1])) {
            if (grid[0][0] == 'x') {
                result = "X Wins";
            } else {
                result = "O Wins";
        ...
        if ((grid[2][0] != '-' && grid[1][1] != '-' && grid[0][2] != '-') && (grid[2][0] == grid[1][1] && grid[0][2] == grid[1][1])) {
        ...
        if (grid[0][0] != '-' && grid[1][0] != '-' && grid[2][0] != '-' && grid[0][1] != '-' && grid[0][2] != '-' && grid[1][1] != '-' && grid[2][2] != '-' && grid[1][2] != '-' &&grid[2][1] != '-') {
